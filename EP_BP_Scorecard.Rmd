...
```{r}
mem_data <- read.csv("/Users/heiyo/Desktop/MQE/Capstone/mem_data_with_noeventandbenefic.csv")
# data from Neel
```
...
library(openxlsx)
benefit_participants <- read.xlsx("/Users/heiyo/Desktop/MQE/Capstone/BenefitParticipants.xlsx")
...
######## UPDATE SCORECARD #######
```{r}
scorecard_data <- read.csv("/Users/heiyo/Desktop/MQE/Capstone/sc_alldata_mems_forcombine.csv")
# 19649 observations
```
